...
class Student(models.Model):
    user = models.ForeignKey(User, on_delete=models.PROTECT, related_name='students')
    student_id = models.CharField(max_length=255, unique=True, blank=True)  ###
    student_roll_id = models.CharField(max_length=255, unique=True, blank=True)
    ...
    def generate_student_id(self):
        ...
        if last_student:
            last_student_id_str = last_student.teacher_id
