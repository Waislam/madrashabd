    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_roll_id', models.CharField(blank=True, max_length=255, unique=True)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='students', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
