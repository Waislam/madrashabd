...
class StudentIncome(models.Model):
    ...
    student_class_id = models.CharField(max_length=30, blank=True)
    amount = models.ForeignKey(Fees, on_delete=models.SET_NULL, related_name='amounts', null=True)
    for_month = models.CharField(max_length=20, default='January', choices=MONTH_CHOICES, null=True)
...
class OtherIncome(models.Model):
    ...
    for_month = models.CharField(max_length=15, default='null', choices=MONTH_CHOICES,)
    for_months = models.CharField(max_length=100, null=True, blank=True)
    paid_date = models.DateField(default=date.today)
...
class AllExpense(models.Model):
    ...
    amount = models.CharField(max_length=20, default='00')
    created_at = models.DateTimeField(auto_now_add=True, null=True)
